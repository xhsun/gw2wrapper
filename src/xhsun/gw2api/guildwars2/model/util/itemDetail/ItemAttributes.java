...
public class ItemAttributes {
	...
	public String toString(){
		return "{Power: "+Power+" Precision: "+Precision+" Toughness: "+Toughness+" Vitality: "+
				Vitality+"Condition Damage: "+cond_dmg+"Condition Duration: "+cond_duration+" Healing: "+Healing+"Boon Duration: "+BoonDuration+"}";
	}
}