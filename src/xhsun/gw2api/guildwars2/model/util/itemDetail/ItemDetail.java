...
public class ItemDetail {
	...
	public enum Unlock{ BagSlot, BankTab, CollectibleCapacity, Content, CraftingRecipe, Dye, Outfit,
		GliderSkin, Champion}
	public enum Attribute{ BoonDuration, ConditionDamage, ConditionDuration, CritDamage, Healing,
